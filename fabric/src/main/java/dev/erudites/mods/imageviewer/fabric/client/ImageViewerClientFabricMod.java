...
public class ImageViewerClientFabricMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        KeyBindingHelper.registerKeyBinding(ImageViewerClient.OPEN_KEY);
        ...
        ClientPlayConnectionEvents.DISCONNECT.register((listener, client) -> ImageViewerClient.onDisconnect(client));
